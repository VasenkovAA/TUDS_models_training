...
class UNetPlusPlus(nn.Module):
    def __init__(self, channel_multiplier: int = 4) -> None:
        ...
        self._skip1 = UNetConv(32 * channel_multiplier, 32 * channel_multiplier)
        self._skip2 = UNetConv(16 * channel_multiplier, 16 * channel_multiplier)
        self._skip3 = UNetConv(8 * channel_multiplier, 8 * channel_multiplier)
        self._skip4 = UNetConv(4 * channel_multiplier, 4 * channel_multiplier)
        self._skip5 = UNetConv(2 * channel_multiplier, 2 * channel_multiplier)
    ...
    def forward(self, X: torch.Tensor) -> torch.Tensor:
        ...
        x = self._up1(x6, x)
        x = self._up2(x5, x + self._skip1(x6))
        x = self._up3(x4, x + self._skip2(x5))
        x = self._up4(x3, x + self._skip3(x4))
        x = self._up5(x2, x + self._skip4(x3))
        x = self._up6(x1, x + self._skip5(x2))
